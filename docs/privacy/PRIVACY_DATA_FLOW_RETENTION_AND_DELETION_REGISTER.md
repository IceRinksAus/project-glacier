...
| ----------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Operator access               | User supplies email/password and privileged users supply TOTP or a recovery code; OWNER manages membership and Event access | Password hash, membership, role, Event assignment, encrypted membership-scoped MFA factor, hashed recovery/challenge authority, authentication session and access/MFA evidence in PostgreSQL | Authorised Glacier operator; future identity/email suppliers only when approved | JWT Organisation context, live membership checks, role/Event guards, revocable eight-hour session, OWNER/MANAGER MFA and bounded OWNER-to-MANAGER reset |
...
| Waiver                        | Signatory supplies name, signature representation, participation choice, optional media/marketing choices and minor name/date of birth | Immutable published wording/hash, acceptance evidence, verification-token hash, optional same-Event Booking/participant links and attributable association audit in PostgreSQL | Credential holder; assigned OWNER/MANAGER; legal/insurer access only under approved process | High sensitivity and child data; public proof excludes identity, signature and child detail; POS/Scanner receives only compact coverage status |
...
| H. Waiver evidence (`WaiverTemplate`, `EventWaiver`, `WaiverVersion`, `WaiverSubmission`, `WaiverMinor`, `WaiverAssociationAudit`) | Template approval provenance; signatory name/signature/choices; acceptance time; minor name/date of birth; explicit Booking Participant links and operator audit | Evidence of disclosed wording, acceptance and operational coverage | Persists indefinitely; no legal hold field or approved automated deletion; proof credentials remain hash-only | Apply the longest approved jurisdiction/insurance/claim period; legal hold overrides ordinary expiry; at approved expiry remove identity/signature/child and association data while retaining only approved non-identifying evidence | Australian lawyer, insurer and privacy adviser; approved Waiver wording, consent and child-data handling |
