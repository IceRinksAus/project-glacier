...
when the JWT secret is too short, when public/CORS origins are not HTTPS origins,
or when Ticket signing-key configuration is incomplete or invalid. Ticket keys
