...
export default function PaymentPage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  const { reservation, paymentSubmitted, setPaymentSubmitted } = useBookingJourney();
  ...
  return (
    <BookingJourneyShell>
      <section className="mx-auto mt-5 max-w-3xl rounded-3xl border bg-white p-6 shadow-sm sm:p-9">
        <p className="text-sm font-semibold uppercase tracking-widest text-slate-500">Step 7 of 7</p>
