...
export interface ProductSalesReport {
  ...
  rows: Array<{
    ...
    variants: Array<{
      ...
      unitsSold: number;
      grossItemSales: number;
      inventoryCommitted: number | null;
...
export interface EventGroupComparisonReport {
  ...
  totals: {
    ...
    productAttachRatePercent: number;
  };
  rows: Array<{
    sortOrder: number;
    event: {
    ...
    revenuePerCapacityPlace: number;
    bookingsWithProducts: number;
    productAttachRatePercent: number;
    grossProductSales: number;
    productRevenuePerAdmission: number;
...
export const reportingService = {
  ...
  getTicketTypeSales: (
    ...
    api.get<TicketTypeSalesReport>(
      eventReportPath(eventId, "/ticket-types", filters),
    ),
  getSessionSales: (
    eventId: string,
    filters: { date?: string; sessionId?: string } = {},
  ...
  getEventGroupComparison: (groupId: string) =>
    api.get<EventGroupComparisonReport>(
      `/reporting/event-groups/${groupId}/comparison`,
    ),
  downloadEventCsv: (
    eventId: string,
    reportType: string,
